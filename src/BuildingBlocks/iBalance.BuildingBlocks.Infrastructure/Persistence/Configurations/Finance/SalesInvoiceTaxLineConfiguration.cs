...
internal sealed class SalesInvoiceTaxLineConfiguration : IEntityTypeConfiguration<SalesInvoiceTaxLine>
{
    public void Configure(EntityTypeBuilder<SalesInvoiceTaxLine> builder)
    {
        builder.ToTable("sales_invoice_tax_lines");
        ...
        builder.HasIndex(x => new { x.SalesInvoiceId, x.TaxCodeId })
            .IsUnique();
    }
}