...
public sealed class SalesInvoiceTaxLine
{
    private SalesInvoiceTaxLine()
    {
    }

    public SalesInvoiceTaxLine(
        Guid id,
        Guid salesInvoiceId,
        Guid taxCodeId,
        ...
        string? description = null)
    {
        if (id == Guid.Empty)
        {
            throw new ArgumentException("Sales invoice tax line id cannot be empty.", nameof(id));
        }

        if (salesInvoiceId == Guid.Empty)
        {
            throw new ArgumentException("Sales invoice id cannot be empty.", nameof(salesInvoiceId));
        }
